...
```r
arrange(gapminder, desc(continent), desc(country), desc(year))
```
...
##  4 New Zealand Oceania    1992    76.3 3437674    18363.
##  5 New Zealand Oceania    1987    74.3 3317166    19007.
##  6 New Zealand Oceania    1982    73.8 3210650    17632.
##  7 New Zealand Oceania    1977    72.2 3164900    16234.
##  8 New Zealand Oceania    1972    71.9 2929100    16046.
##  9 New Zealand Oceania    1967    71.5 2728150    14464.
...
#cmd+shift+m is a shortcut for adding the pipe operator.
gapminder %>% #this line selects databse
select(year, lifeExp, country) %>% #this line selects the three columns.
arrange(year, lifeExp) #this column arranges the selected dataframe.
```
...
gapminder %>%
  mutate(gdpBill=gdpPercap*pop/1000000000) %>% 
  round(gdpBill, digits = 2)
```

```
## Error in function_list[[k]](value): object 'gdpBill' not found
```
